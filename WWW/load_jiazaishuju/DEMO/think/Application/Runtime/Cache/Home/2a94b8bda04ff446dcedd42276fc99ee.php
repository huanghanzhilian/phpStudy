...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/ceshi/DEMO/think/Public/style/admin_index.css">
	<script type="text/javascript" src="/ceshi/DEMO/think/Public/script/admin_index.js"></script>
</head>
	...
	<div class="header">
        ...
        <ul class="head_text fr">
	        <li class="head_text_li">
	        	<img class="avatar" src="/ceshi/DEMO/think/Public/image/head portrait.png">
