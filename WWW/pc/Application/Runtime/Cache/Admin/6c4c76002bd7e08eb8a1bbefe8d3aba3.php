...
<a href="/index.php/Admin/index/index">返回</a><br /><br />
	<a href="/index.php/Admin/Ddguanli/dengdai/ways_id/3">等待指派</a><br /><br />
	<a href="/index.php/Admin/Ddguanli/yizhipai/ways_id/3">已指派</a><br /><br />
	<a href="/index.php/Admin/Ddguanli/yijiedan/ways_id/3">已接单</a><br /><br />
	<a href="/index.php/Admin/Ddguanli/weixiuzhong/ways_id/3">维修中</a><br /><br />
	<a href="/index.php/Admin/Ddguanli/daifukuan/ways_id/3">待付款</a><br /><br />
	<a href="/index.php/Admin/Ddguanli/jiaoyiwancheng/ways_id/3">交易完成</a><br /><br />
	<div id='list'>
<table border=1>
<th>订单号：</th>
<th>机型：</th>
...
<?php if(is_array($arr)): foreach($arr as $key=>$vv): ?><tr>
	...
	<td><?php echo ($vv["u_phone"]); ?></td>
	 <td>
	<a href="/index.php/Admin/Ddguanli/xiangqing/id/<?php echo ($vv["id"]); ?>/ways_id/<?php echo ($ways_id); ?>">详情</a>
	 </td>
	<td>
...
<script type="text/javascript">
	function ajax(page){
		...
		var ajax=new XMLHttpRequest()
			ajax.open("get","/index.php/Admin/Ddguanli/jixiufenye/page/"+page+"/ways_id/"+3,true)
			ajax.send()
