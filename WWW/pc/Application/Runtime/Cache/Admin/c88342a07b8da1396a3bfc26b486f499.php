...
<body>
<a href="/index.php/Admin/Ddguanli/<?php echo ($b); ?>/ways_id/<?php echo ($ways_id); ?>/stau/<?php echo ($arr["stau"]); ?>">返回</a>
	...
	<a href="/index.php/Admin/Ddguanli/quxiaodedingdan/id/<?php echo ($vv["id"]); ?>/">取消</a>
</body>
</html>