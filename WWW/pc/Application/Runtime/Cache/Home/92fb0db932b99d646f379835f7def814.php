...
<div class="content">
    <div class="content_con">
        <div class="dingdan">
            <ul class="clearfix">
                 <li>
                    <a href="/index.php/Home/Index/shifu">新订单</a>
                 </li>
                 <li>
                    <a class="on" href="/index.php/Home/Index/daiwancheng">待完成</a>
                 </li>
                 <li>
                    <a href="/index.php/Home/Index/yiwancheng">已完成</a>
                 </li>
            </ul>
        </div>
        ...
        <?php if(is_array($arr)): foreach($arr as $key=>$vv): ?><div class="jixing">
            ...
            <div class="jixing_title jixing_title1 jixing_title2">
                <span></span>
                订单编号：<?php echo ($vv["ddh"]); ?>
                <em><a href="/index.php/Home/Index/daiwanchengxq/id/<?php echo ($vv["id"]); ?>">详情</a></em>
            </div>
            ...
            <div class="jixing_btn">
                ...
                <h1><?php echo ($vv["xo_time"]); ?><span>编辑</span></h1>
...
<?php if(is_array($arr)): foreach($arr as $key=>$vv): ?><tr>
	...
	<td><a href="/index.php/Home/Index/daiwanchengxq/id/<?php echo ($vv["id"]); ?>">详情</a></td>	
