...
<div class="header">
    ...
    <h1>手机维修
    <!--&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($my); ?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/index.php/Home/Gouwuche/goumaichanpin">购买产品</a>-->
    <!--<span></span>-->
    </h1>
    <div class="popup">
        <ul>
                        ...
                        <?php if(is_array($arr)): foreach($arr as $key=>$kk): ?><li><!--<span><i></i><em></em></span>--><b></b><?php echo ($kk["model_name"]); ?>
                            <ul>
                             <?php if(is_array($kk['data'])): foreach($kk['data'] as $key=>$ee): ?><li>
                                    <a href="/index.php/Home/Index/wenti/model_id/<?php echo ($kk["model_id"]); ?>/color_id/<?php echo ($ee["color_id"]); ?>"><?php echo ($ee["color_name"]); ?></a>
		...
		var ajax=new XMLHttpRequest()
		    ...
		    $(".models>.models_lis>#list >ul> li").click(function(){
                ...
                $("body").ajaxStop(function(){
                    ...
                    var $this = $(this);
                    $.ajax({
                        url: "/index.php/Home/Index/ajaxp",
