...
<!--<a href="/index.php/Home/Index/xindingdan">返回</a><br /><br />
...
<?php echo ($r); ?> <br />
	...
	<a href="/index.php/Home/Index/jiedan/id/<?php echo ($arr["id"]); ?>/stau/<?php echo ($arr["stau"]); ?>"><?php echo ($b); ?></a><br /><br />
	<a href="/index.php/Home/Index/tuidan/id/<?php echo ($arr["id"]); ?>/stau/<?php echo ($arr["stau"]); ?>"><?php echo ($c); ?></a>	-->
...
<div class="jiedan">
    <div class="jiedan_box clearfix">
        ...
        <a class="on"  href="/index.php/Home/Index/jiedan/id/<?php echo ($arr["id"]); ?>/stau/<?php echo ($arr["stau"]); ?>"><?php echo ($b); ?></a>	
		<a class="on"  href="/index.php/Home/Index/qiangdan/id/<?php echo ($arr["id"]); ?>/stau/<?php echo ($arr["stau"]); ?>"><?php echo ($v); ?></a>
    </div>
</div>
</body>
</html>