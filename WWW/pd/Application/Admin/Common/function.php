 ...
 */
 ...
 function piii($chanel='wx_pub' ,$good= array() , $user = array()){
	// 导入Ping ++ sdk
	Vendor("Pingg.init");
	// 提取 Config 内的配置
	$ping_config = [
        'ping_api_id'  => 'app_X9uTCCHu1GmH5aHe',                            // ping++的APP id
        'ping_api_key' => 'sk_live_CO88mD8WjH04CCu1e1z1Wn1C',                // ping++的API KEY
        'success_url'  => 'http://m.weibaishi.com/admin/pay/index',   // 成功返回处理结果的URL
        'cancel_url'   => 'http://m.weibaishi.com/admin/pay/index',   // 支付取消回调地址
...
function pingpa($channel = "alipay_wap",$good = array() , $user = array() ){
	// 导入Ping ++ sdk
	Vendor("Pingg.init");
	
	$ping_configggg = [
        'ping_api_id'  => 'app_X9uTCCHu1GmH5aHe',//app_LybXDOHyvLS4yPmH// ping++的APP id
        'ping_api_key' => 'sk_live_CO88mD8WjH04CCu1e1z1Wn1C',                // ping++的API KEY
        'success_url'  => 'http://m.weibaishi.com/admin/pay/index',   // 成功返回处理结果的URL
        'cancel_url'   => 'http://m.weibaishi.com/admin/pay/index',   // 支付取消回调地址
...
function pingp($channel = "alipay_wap",$good = array() , $user = array() ){
	// 导入Ping ++ sdk
	Vendor("Pingg.init");
	// 提取 Config 内的配置
	$ping_configggg = [
        'ping_api_id'  => 'app_b1mvjPWLmfzPOajL',//app_LybXDOHyvLS4yPmH// ping++的APP id
        'ping_api_key' => 'sk_live_CO88mD8WjH04CCu1e1z1Wn1C',                // ping++的API KEY
        'success_url'  => 'http://m.weibaishi.com/admin/pay/index',   // 成功返回处理结果的URL
        'cancel_url'   => 'http://m.weibaishi.com/admin/pay/index',   // 支付取消回调地址
