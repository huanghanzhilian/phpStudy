...
define('_XZROOT_',APP_PATH.'Common/Util/Kf/core/');

require_once _XZROOT_.'apiRequire.php';
//if(!defined('APP_PATH')) exit('no auth');
//require APP_PATH.'Common/Util/Kf/core/apiRequire.php';
class Client{
