...
<a href="/Admin/Index/index">返回</a><br /><br />
	...
	<?php if(is_array($arr)): foreach($arr as $key=>$kk): echo ($kk["ddh"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($kk["cpk_name"]); ?> &nbsp;&nbsp;<?php echo ($kk["cpk_price"]); ?>元&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($kk["user_username"]); ?><br /><br /><?php endforeach; endif; ?>
</body>
</html>