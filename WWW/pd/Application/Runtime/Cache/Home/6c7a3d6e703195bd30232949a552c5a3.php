    ...
    <div class="content_con">
        ...
        <div class="zhifu_neir">
            ...
            <ul>
				...
				<!-- <li>
                    <i class="bbctin1"></i><span>支付宝手机在线支付</span><input class="tijfsn" type="radio" name="tijfsn" value="服务投诉" id="fwts1" checked="checked" /><em></em>
                </li> -->
				<li>
                    <i class="bbctin2"></i><span>微信在线支付</span><input class="tijfsn" type="radio" name="tijfsn" value="服务投诉" id="fwts2"  /><em></em>
                </li> 			
   
				<input type="hidden" name="id" value='<?php echo ($good["ddh"]); ?>'>
...
$(function(){
	...
	$(".zhifu_neir li").click(function(){
			...
			if($("#fwts1").attr('checked')){
				...
				$("#form_bbd").attr("action", "/Home/Wxpay/index")
			}else if($("#fwts3").attr('checked')){
				$("#form_bbd").attr("action", "/Home/Gouwuche/yuequfukuan/id/<?php echo ($good["id"]); ?>")
			}else{
				$("#form_bbd").attr("action", "/Home/Gouwuche/fukuan/id/<?php echo ($good["id"]); ?>")
			}
	})
