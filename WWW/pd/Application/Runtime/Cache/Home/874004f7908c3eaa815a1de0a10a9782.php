        ...
        <div class="shifudu_top">
            <ul class="pubcvt shifudu_top_ul shifudu_top_ul_gd">
                <li class="pubcvt_v shifudu_top_li ">
                    <a href="/Home/Shifu/history_a">已完成<span>(<?php echo ($nums1); ?>)</span></a>
                </li>
                <li class="pubcvt_v shifudu_top_li shifudu_top_li_1">
                    <a href="/Home/Shifu/history_b">已取消<span>(<?php echo ($nums2); ?>)</span></a>
                </li>
                <!--<li class="pubcvt_v shifudu_top_li">
                    <a href="/Home/Shifu/history_c">售后中<span>(2)</span></a>
                </li>-->
            </ul>
        </div>
        <!--tab头-->
