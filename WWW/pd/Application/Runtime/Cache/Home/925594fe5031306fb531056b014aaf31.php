...
<a href="/ceshi/www/index.php/Home/Index/index/" style="display:none;">返回首页</a><center style="display:none;"><?php echo ($my); ?></center>
	<center style="display:none;"><h1><a href="/ceshi/www/index.php/Home/Index/dingdan">未付款</a> <a href="/ceshi/www/index.php/Home/Index/fuku">已付款</a></h1></center>
    
    <div class="dingdan">
        <ul class="clearfix">
             <li>
                <a href="/ceshi/www/index.php/Home/Index/dingdan">未付款</a>
             </li>
             <li>
                <a href="/ceshi/www/index.php/Home/Index/fuku">已付款</a>
             </li>
             <li>
                <a href="/ceshi/www/index.php/Home/Index/membercentent">用户中心</a>
             </li>
        </ul>
    </div>
    ...
    <?php if(is_array($arr)): foreach($arr as $key=>$kk): ?><div class="jixing">
        <div class="jixing_title">
            ...
            <em><a href="/ceshi/www/index.php/Home/Index/shouhou/id/<?php echo ($kk["id"]); ?>">售后保修</a></em>
        </div>
   ...
   <!-- <div class="jixing">
	...
	<?php if(is_array($arr)): foreach($arr as $key=>$kk): ?><tr>
			...
			<td><a href="/ceshi/www/index.php/Home/Index/shouhou/id/<?php echo ($kk["id"]); ?>">售后保修</a></td>
