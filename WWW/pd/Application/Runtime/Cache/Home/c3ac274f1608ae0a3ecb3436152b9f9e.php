...
<div class="content">
    ...
    <a style="position: fixed; bottom: 0px; background:#3e7edb; text-align:center; color:#fff; line-height:50px; width:100%;" href="/Home/Shifu/qrcode/ddh/<?php echo ($ddh); ?>"><?php echo ($lj); ?> <b><?php echo ($amount); ?></b></a>
...
/*function fuoopy(){
	//$("#quxiaopp").click()
	var huuop=document.getElementById('quxiaopp');
	huuop.onclick
}*/
/*$(function(){
	$("#quxiaopp").click()
