                ...
                <div class="">
                    <ul id="list_l_box" class="list_l_box">
                        <li class="aet_list on">
                            <a href="/Admin/Ddguanli/dengdai/ways_id/1">待分配</a>
                        </li>
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/yizhipai/ways_id/1">已指派</a>
                        </li>
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/yijiedan/ways_id/1">已接单</a>
                        </li>
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/weixiuzhong/ways_id/1">维修中</a>
                        </li>
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/daifukuan/ways_id/1">待付款</a>
                        </li>
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/jiaoyiwancheng/ways_id/1">已完成</a>
                        </li>
                        <li class="aet_list">
...
<!--    <a href="/Admin/Ddguanli/quxiaole">取消的订单</a>
    <center>
        <h1>
            <a href="/Admin/Ddguanli/jixiu/ways_id/3">寄修</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="/Admin/Ddguanli/daodian/ways_id/2">到店</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="/Admin/Ddguanli/shangmen/ways_id/1">上门</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        
        </h1>
    </center>
    <a href="/Admin/index/index">返回</a><br /><br />
        <a href="/Admin/Ddguanli/dengdai/ways_id/1">等待指派</a><br /><br />
        <a href="/Admin/Ddguanli/yizhipai/ways_id/1">已指派</a><br /><br />
        <a href="/Admin/Ddguanli/yijiedan/ways_id/1">已接单</a><br /><br />
        <a href="/Admin/Ddguanli/weixiuzhong/ways_id/1">维修中</a><br /><br />
        <a href="/Admin/Ddguanli/daifukuan/ways_id/1">待付款</a><br /><br />
        <a href="/Admin/Ddguanli/jiaoyiwancheng/ways_id/1">交易完成</a><br /><br />
    <table border=1>
    <th>订单号：</th>
    <th>机型：</th>
    <th>问题：</th>
    ...
    <?php if(is_array($arr)): foreach($arr as $key=>$vv): ?><tr>
        ...
        <td><?php echo ($vv["u_phone"]); ?></td>
         <td><a href="/Admin/Ddguanli/xiangqing/id/<?php echo ($vv["id"]); ?>/ways_id/<?php echo ($ways_id); ?>">详情</a></td>
        <td>
        <a href="/Admin/Ddguanli/wxuser/id/<?php echo ($vv["id"]); ?>/ways_id/<?php echo ($ways_id); ?>">待分配</a>
        </td>
         <td>
        <a href="/Admin/Ddguanli/shanchu/id/<?php echo ($vv["id"]); ?>/ways_id/<?php echo ($ways_id); ?>">删除</a>
         </td> 
          <td>
        <a href="/Admin/Ddguanli/quxiao/id/<?php echo ($vv["id"]); ?>/ways_id/<?php echo ($ways_id); ?>">取消</a>
         </td>
