                ...
                <div class="">
                    <ul id="list_l_box" class="list_l_box">
                        <li class="aet_list on">
                            <a href="/Admin/Ddguanli/dengdai/ways_id/3">待分配</a>
                        </li>
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/yizhipai/ways_id/3">已指派</a>
                        </li>
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/yijiedan/ways_id/3">已接单</a>
                        </li>
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/weixiuzhong/ways_id/3">维修中</a>
                        </li>
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/daifukuan/ways_id/3">待付款</a>
                        </li>
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/jiaoyiwancheng/ways_id/3">已完成</a>
                        </li>
                        <li class="aet_list">
...
<script type="text/javascript">
	function ajax(page){
		...
		var ajax=new XMLHttpRequest()
			ajax.open("get","/Admin/Ddguanli/jixiufenye/page/"+page+"/ways_id/"+3,true)
			ajax.send()
			ajax.onreadystatechange=function(){
				if(ajax.readyState==4 && ajax.status==200){
					document.getElementById('listaa').innerHTML=ajax.responseText
				}
			}
}
