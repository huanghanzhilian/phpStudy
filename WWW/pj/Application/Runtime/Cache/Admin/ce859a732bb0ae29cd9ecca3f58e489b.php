...
$(function() {   		
	...
	spstr = sid.split("");
	var jjk=spstr[spstr.length-1];
	//console.log(jjk);
	if(jjk){
		$(".shifudu_top_li").eq(jjk-1).addClass('shifudu_top_li_1');
	}
})
</script>
</head>
            ...
            <div class="brands fl">
                <div class="">
                    <ul id="list_l_box" class="list_l_box">
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/dengdai/ways_id/<?php echo ($ways_id); ?>">待分配</a>
                        </li>
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/yizhipai/ways_id/<?php echo ($ways_id); ?>">已指派</a>
                        </li>
                        <li class="aet_list ">
                            <a href="/Admin/Ddguanli/yijiedan/ways_id/<?php echo ($ways_id); ?>">已接单</a>
                        </li>
                        <li class="aet_list on">
                            <a href="/Admin/Ddguanli/weixiuzhong/ways_id/<?php echo ($ways_id); ?>">维修中</a>
                        </li>
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/daifukuan/ways_id/<?php echo ($ways_id); ?>">待付款</a>
                        </li>
                        <li class="aet_list">
                            <a href="/Admin/Ddguanli/jiaoyiwancheng/ways_id/<?php echo ($ways_id); ?>">已完成</a>
                        </li>
                        <li class="aet_list">
