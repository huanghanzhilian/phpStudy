...
<div class="header public_width">
    <h1 class="header_h1">产品库 &gt; 手机维修 &gt; <?php echo ($model_name); ?> &gt; 问题</h1>
</div>
...
<div class="container public_width">
    ...
    <div class="append_cp">
        <div class="append_cp_box clearfix">
            <button class="append_cp_anniu_but" id="tianco">重新添加新问题</button>
    ...
    <div class="container_modify" id="xgpinpan">
        <ul class="zhuti_rom">
            <?php if(is_array($arr)): foreach($arr as $key=>$k): ?><li class="">
                    <div class="zhuti_rom_list_r fr zhuti_rom_list_ncon">
                        <a class="Return_button_a1" href="/Admin/Shangpin/question/model_id/<?php echo ($model_id); ?>/brand_id/<?php echo ($brand_id); ?>/questiontype_id/<?php echo ($k["questiontype_id"]); ?>">查看小问题</a>
                    </div>
                    <strong class="buctrese"><?php echo ($k["questiontype_name"]); ?></strong>
    ...
    <div class="bikuss" id="bikuss">
        <ul class="zhuti_rom zhuti_rom_a1">
            <form method="post" action="/Admin/Shangpin/questadd" onSubmit="return Checked();">
                
                <h2 class="erji_h2">重新添加新问题</h2>
                <li class="">
                    <?php if(is_array($arr1)): foreach($arr1 as $key=>$kk): ?><span class="Return_button_a1 Return_button_a2 color_ya"><?php echo ($kk["questiontype_name"]); ?></span><input class="color_ya_input" type="checkbox" name="questiontype_id[]" value='<?php echo ($kk["questiontype_id"]); ?>'><?php endforeach; endif; ?>
                </li>
