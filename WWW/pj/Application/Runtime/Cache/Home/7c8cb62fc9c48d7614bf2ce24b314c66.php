            ...
            <ul class="pubcvt gezxin_top_dis">
                <li class="pubcvt_v">
                    ...
                    <em>
                        ...
                        <span>平均评分:<?php echo ($arr1["pf"]); ?></span>
                    </em>
                </li>
            ...
            <div class="huadonhmk">
                <ul>
                    <?php if(is_array($arr)): foreach($arr as $key=>$k): ?><li>
                            <b>1</b><img  src="/Public/<?php echo ($k["img"]); ?>" width=20 height=20 /><span><?php echo ($k["user_username"]); ?></span><div class="fr"><?php echo ($k["pf"]); ?></div>
