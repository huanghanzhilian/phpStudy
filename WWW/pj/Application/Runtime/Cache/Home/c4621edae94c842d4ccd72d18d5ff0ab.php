...
<div class="content">
    <div class="content_con">
        <div class="dingdan">
            <ul class="clearfix">
                 <li>
                    <a class="on" href="/ceshi/www/index.php/Home/Index/shifu">新订单</a>
                 </li>
                 <li>
                    <a href="/ceshi/www/index.php/Home/Index/daiwancheng">待完成</a>
                 </li>
                 <li>
        ...
        <?php if(is_array($arr)): foreach($arr as $key=>$vv): ?><div class="jixing">
            ...
            <div class="jixing_title jixing_title1">
                ...
                <em><a href="/ceshi/www/index.php/Home/Index/shifuxiangqing/id/<?php echo ($vv["id"]); ?>">详情</a></em>
            </div>
...
<?php if(is_array($arr)): foreach($arr as $key=>$vv): ?><tr>
	...
	<td><a href="/ceshi/www/index.php/Home/Index/shifuxiangqing/id/<?php echo ($vv["id"]); ?>">详情</a></td>	
