...
<link rel="shortcut icon" href="/ceshi/www/Public/img/ioc/16.ioc"><!--图标-->
<link rel="icon" href="/ceshi/www/Public/img/ioc/16.png"><!--图标-->
...
<script type="text/javascript" src="/ceshi/www/Public/js/iscroll.js"></script>
...
<div class="header">
    ...
    <h1>手机维修
    <!--&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($my); ?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/ceshi/www/index.php/Home/Gouwuche/goumaichanpin">购买产品</a>-->
    <!--<span></span>-->
    </h1>
    <div class="popup">
        <ul>
                        ...
                        <?php if(is_array($arr)): foreach($arr as $key=>$kk): ?><li><!--<span><i></i><em></em></span>--><b></b><?php echo ($kk["model_name"]); ?>
                            <ul>
                             <?php if(is_array($kk['data'])): foreach($kk['data'] as $key=>$ee): ?><li>
                                    <a href="/ceshi/www/index.php/Home/Index/wenti/model_id/<?php echo ($kk["model_id"]); ?>/color_id/<?php echo ($ee["color_id"]); ?>"><?php echo ($ee["color_name"]); ?></a>
...
<script type="text/javascript">
      function fengcore(){
          ...
          documentHeight=$("#models_lis_c").height()+230;//内部滑动模块的高度
	...
	function ajaxpp(brand_id){
		...
		var ajax=new XMLHttpRequest()
			ajax.open("get","/ceshi/www/index.php/Home/Index/ajaxp/brand_id/"+brand_id,true)
			//alert(brand_id);
			ajax.send()
		    ...
		    $(".models>.models_lis>#list >ul> li").click(function(){
			    ...
			    $("body").ajaxStart(function(){ 
                    $(this).append('<div class="jztp"><img src="/ceshi/www/Public/img/jz.gif"/></div>');
					$(".Maskc1").show();
                ...
                $("body").ajaxStop(function(){
                    ...
                    var $this = $(this);
                    $.ajax({
                        url: "/ceshi/www/index.php/Home/Index/ajaxp",
                        ...
                        $(".models>.models_lis>ul").html( data);
							...
							$(".models>.models_lis>ul> li").click(function(){
								...
								$(this).find('b').css({'background-color':'#4fabef'})
								//loaded1()
								};
