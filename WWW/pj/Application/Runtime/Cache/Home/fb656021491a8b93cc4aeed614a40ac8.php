...
<div class="content">
    ...
    <div class="da_con">
        <h1>订单编号：<?php echo ($arr["u_number"]); ?></h1>
        <ul>
            <li>
...
<!--<a href="/ceshi/www/index.php/Home/Index/xindingdan">返回</a><br /><br />
...
<?php echo ($r); ?> <br />
	...
	<a href="/ceshi/www/index.php/Home/Index/jiedan/id/<?php echo ($arr["id"]); ?>/stau/<?php echo ($arr["stau"]); ?>"><?php echo ($b); ?></a><br /><br />
	<a href="/ceshi/www/index.php/Home/Index/tuidan/id/<?php echo ($arr["id"]); ?>/stau/<?php echo ($arr["stau"]); ?>"><?php echo ($c); ?></a>	-->
...
<div class="jiedan">
    <div class="jiedan_box clearfix">
	    ...
	    <a  href="/ceshi/www/index.php/Home/Index/tuidan/id/<?php echo ($arr["id"]); ?>/stau/<?php echo ($arr["stau"]); ?>"><?php echo ($c); ?></a>
        <a class="on"  href="/ceshi/www/index.php/Home/Index/jiedan/id/<?php echo ($arr["id"]); ?>/stau/<?php echo ($arr["stau"]); ?>"><?php echo ($b); ?></a>	
    </div>
</div>
</body>
</html>