...
$sku_id=iconv('gb2312','utf-8',odbc_result($quee,49));//sku-id
...
,goods_price,goods_nums,discount_price,sum_price,goods_content,goods_color,shop_card,goods_card,sku_id,qibiao,forum,order_state
,revise_time,order_number,order_time,zt)values('$username','$usernamee','$phone','$post_code','$country','$province','$city','$district','$address','$logistics_number','$goods_name','$goods_na','$goods_number','$goods_price','$goods_nums','$discount_price','$sum_price','$goods_content','$goods_color','$shop_card','$goods_card','$sku_id','$qibiao','$forum','$order_state','$revise_time','$order_number','$order_time','1')";
